...
create table usuarios ( id int(11) auto_increment, usuario varchar(20), senha varchar(128), nivel int(1), primary key(id) );
...
INSERT INTO `odin`.`usuarios` (`id`, `usuario`, `senha`, `nivel`) VALUES (NULL, 'paico', 'fa38f3103751a64c615d9eb5c1b662fe7d90d6dd2694a21e5efdad3090bc3a1e7d9976f3c9a5f94bc9f1e75920d841b4ffb9f9ab9e6043a41db50117abdebbf0', '1'); 
